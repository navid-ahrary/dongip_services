...
module.exports = function (controllerName) {
  ...
  classes[controllerName] = class {
    ...
    async create(entity) {
      return this.controllerRepository.create(entity);
    }
    async count(where) {
      return this.controllerRepository.count(where);
    }
    async find(filter) {
      return this.controllerRepository.find(filter);
    }
    async updateAll(entity, where) {
      return this.controllerRepository.updateAll(entity, where);
    }
    async findById(id) {
