...
function param(paramSpec) {
    return function (target, member, index) {
        ...
        context_1.ParameterDecoratorFactory.createDecorator(keys_1.OAI3Keys.PARAMETERS_KEY, paramSpec, { decoratorName: '@param' })(target, member, index);
    };
}
exports.param = param;
/**
...
function createParamShortcut(source, options) {
    return (name, spec) => {
        return param(Object.assign({ name, in: source, schema: Object.assign({}, options) }, spec));
    };
}
