...
MongoDB.prototype.create = function (model, data, options, callback) {
  ...
  this.execute(model, 'insertOne', data, {
    safe: true
  }, function (err, result) {
    if (self.debug) {
...
MongoDB.prototype.replaceOrCreate = function (model, data, options, cb) {
  ...
  delete data[idName];
  this.replaceWithOptions(model, oid, data, {
    upsert: true
  }, cb);
};
...
MongoDB.prototype.replaceWithOptions = function (model, id, data, options, cb) {
  ...
  var idName = self.idName(model);
  delete data[idName];
  this.execute(model, 'replaceOne', {
    _id: id
  }, data, options, function (
    err,
    info
  ) {
    debug('updateWithOptions.callback', model, {
      _id: id
    }, data, err, info);
