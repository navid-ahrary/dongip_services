...
var Neo4j = function (settings, dataSource) {
    ...
    this.username = settings.user || settings.username || neo4j;
    this.password = settings.pass || settings.password || neo4j;
...
Neo4j.prototype.create = function (model, data, options, callback) {
    "use strict";
    var self = this,
        session = self.db.session(neo4j.session.WRITE),
...
Neo4j.prototype.count = function (model, where, options, callback) {
    "use strict";
    var self = this,
        session = self.db.session(neo4j.session.READ),
        query = `MATCH (n: ${self.label(model)})`,
        params = {},
        cypher = {},
        count = '';
