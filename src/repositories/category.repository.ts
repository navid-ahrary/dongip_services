...
import {
  ...
  Users,
  CategoryBill,
  VirtualUsers, BillList, PayerList} from '../models';
...
> {
  ...
  public readonly billList: HasManyRepositoryFactory<BillList, typeof Category.prototype.id>;

  public readonly payerList: HasManyRepositoryFactory<PayerList, typeof Category.prototype.id>;
  ...
  constructor(
    ...
    protected categoryBillRepositoryGetter: Getter<CategoryBillRepository>, @repository.getter('BillListRepository') protected billListRepositoryGetter: Getter<BillListRepository>, @repository.getter('PayerListRepository') protected payerListRepositoryGetter: Getter<PayerListRepository>,
  ) {
